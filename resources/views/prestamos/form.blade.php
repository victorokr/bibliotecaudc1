			  	 ...
			  	 <div class="col-12">
			  		<div class="input-group input-group-sm mb-4"> 
				  	  <div class="input-group-prepend">	
			  			  ...
			  			  <select name="materialBibliotecas[]"  class="libros form-control custom-select mr-sm-2" id="validationCustom1"  multiple="multiple" style="width: 265px" title="Ingresa el libro de la busqueda"   required> 
				 ...
				 <div class="col-12">
			  		<div class="input-group input-group-sm mb-4"> 
				  	  <div class="input-group-prepend">	
			  			  ...
			  			  <select name="ubicaciones[]" class="sede form-control custom-select mr-sm-2" id="validationCustom03"  multiple="multiple" style="width: 210px" title="Ingresa el libro de la busqueda" required> 
